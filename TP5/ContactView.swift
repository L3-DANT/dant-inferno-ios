...
class ContactView: UITableViewController {
   ...
   @IBOutlet weak var UrlButton: UIButton!
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
         ...
         return ConnectionView.cellInfo.count
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = ConnectionView.cellInfo[indexPath.row].login //"Test"
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if ConnectionView.cellInfo[indexPath.row].checkmark == true{
            
            tableView.cellForRow(at: indexPath)?.accessoryType = .none
            ConnectionView.cellInfo[indexPath.row].checkmark  = false
            
            
        }else{
            
            tableView.cellForRow(at: indexPath)?.accessoryType = .checkmark
            ConnectionView.cellInfo[indexPath.row].checkmark  = true
